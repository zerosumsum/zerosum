...
Your frontend now supports **Base Sepolia, Celo Sepolia, and Celo Mainnet** with the latest deployed contract addresses.
...
# Celo Mainnet
NEXT_PUBLIC_CELO_MAINNET_GAME_CONTRACT=0x3688Ce0123de9583cB39aA90907049Ef4077D810
NEXT_PUBLIC_CELO_MAINNET_SPECTATOR_CONTRACT=0xe4608436ec4eE31dc63D71af6c06D45E5a15a512

# Default Network
NEXT_PUBLIC_DEFAULT_NETWORK=celoMainnet
```
...
function BettingComponent() {
  const { needsSwitch, promptSwitch } = useNetworkCheck('celoMainnet');
