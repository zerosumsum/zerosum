...
const EXPLORER_URLS: Record<number, string> = {
  84532: process.env.NEXT_PUBLIC_BASE_EXPLORER || "https://sepolia.basescan.org",
  11142220: process.env.NEXT_PUBLIC_CELO_EXPLORER || "https://alfajores.celoscan.io",
  42220: process.env.NEXT_PUBLIC_CELO_MAINNET_EXPLORER || "https://celoscan.io",
}
...
export function useZeroSumContract() {
  ...
  const executeTransaction = async (
    ...
    try {
      ...
      console.log(`🔗 View on explorer: ${getExplorerTxUrl(chainId, hash)}`)
